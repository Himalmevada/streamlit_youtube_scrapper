...
def scrape_youtube_data(url):
    ...
    for index in range(0, 20):
        ...
        views = (
            all_data[index]
            .findAll("span", "inline-metadata-item style-scope ytd-video-meta-block")[0]
            .text
        )
        uploaded_time = (
            all_data[index]
            .findAll("span", "inline-metadata-item style-scope ytd-video-meta-block")[1]
            .text
        )
